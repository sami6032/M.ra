...
<head>
  ...
  <!-- Favicons -->
  <link href="assetes/img/favicon.png" rel="icon">
  <link href="assetes/img/apple-touch-icon.png" rel="apple-touch-icon">
...
<!-- <section id="breadcrumbs" class="breadcrumbs">
      <div class="container ">
        <div class="row"></div>
      <div class="col-6" style="width: 95px; margin-top:05px; margin-left:60px">
            <img width="95px" src="frontend/images/LOGO.png" alt="Logo Image">
        </div>
        <div class="col-6" class="d-flex justify-content-between align-items-center">
